...
import 'package:my_flutter_app/repeated_function/userreview.dart';
import 'package:my_flutter_app/repeated_function/trailerui.dart';
  ...
  Future<void> tvseriesdetailfunc() async {
    ...
    if (tvseriesdetailresponse.statusCode == 200) {
      ...
      for (var i = 0; i < tvseriesdetaildata['genres'].length; i++) {
        TvSeriesDetails.add({'genre': tvseriesdetaildata['genres'][i]['name']});
      }
          ...
          "rating":
              tvseriesreviewdata['results'][i]['author_details']['rating'] ==
                  ...
                  : tvseriesreviewdata['results'][i]['author_details']['rating']
                      .toString(),
          "avatarphoto":
              tvseriesreviewdata['results'][i]['author_details']['avatar_path'] ==
                      null
                  ? "https://www.pngitem.com/pimgs/m/146-1468479_my-profile-icon-blank-profile-picture-circle-hd.png"
                  : "https://image.tmdb.org/t/p/w500" +
                      tvseriesreviewdata['results'][i]['author_details']['avatar_path'],
          "creationdate": tvseriesreviewdata['results'][i]['created_at']
              .substring(0, 10),
